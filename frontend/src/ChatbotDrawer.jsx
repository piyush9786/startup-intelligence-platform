      ...
      {open && (
        ...
        >
          <header className="chatbot-drawer-header">
            <div>
              <span className="section-kicker">
                GROUNDED WORKSPACE HELP
              </span>
              <h2 id="founder-assistant-title">
                Founder assistant
              </h2>
              <p>
                Navigation and startup context from
          ...
          <footer className="chatbot-disclaimer">
            Deterministic readiness, eligibility,
            recommendation, verification, deadline, and
            sequencing records remain authoritative.
          </footer>
        </section>
      )}
    </>
