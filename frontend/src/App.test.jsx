...
vi.mock("./i18n/index.jsx", () => {
  const translations = {
    ...
    "dashboard.catalog_ready": "{count} verified schemes ready",
    "dashboard.verified_schemes": "Verified schemes",
    "dashboard.browse_verified_schemes": "Browse the verified scheme catalog",
    "dashboard.verified_catalog_title": "Verified schemes to explore",
    "dashboard.verified_catalog_kicker": "Official reviewed catalog",
    "dashboard.verified_catalog_badge": "Verified catalog",
    "dashboard.recommended_title": "Recommended for your startup",
    "dashboard.ranking_kicker": "Eligibility and ranking output",
    "dashboard.scheme_search_empty": "No scheme matches this search",
    "dashboard.no_eligible_schemes": "No eligible scheme matches yet",
    "dashboard.catalog_empty": "Verified scheme catalog is empty",
    "dashboard.try_another_search": "Try another search term.",
    "dashboard.review_unmatched": "Review the unmatched schemes and their eligibility requirements below.",
    "dashboard.catalog_bootstrap_hint": "Restart the backend catalog bootstrap, then refresh this page.",
    "dashboard.authority_unavailable": "Authority details unavailable",
    "dashboard.reviewer_evidence": "Reviewer-approved evidence",
    "dashboard.ranking_score": "Ranking score",
    "dashboard.support_details_available": "Support details available",
    "dashboard.eligibility_review": "Eligibility review",
    "dashboard.evaluated_unmatched": "Evaluated but not matched",
    "dashboard.evaluated_search_empty": "No evaluated scheme matches this search",
    "dashboard.open_action_roadmap": "Open action roadmap",
  };
  const t = (key, vars = {}) => {
...
describe("functional user dashboard", () => {
  test("shows the verified catalog before recommendations are generated", async () => {
    ...
    expect(
      await screen.findByRole("heading", {
        name: "Verified schemes to explore",
      }),
    ).toBeInTheDocument();
    expect(
  ...
  test("prioritizes the persisted next action before discovery tools", async () => {
    ...
    expect(await screen.findByRole("button", { name: "Open action roadmap" }),
    ).toBeInTheDocument();
